...
#[test]
fn intent_stellar_golden2() {
    let model_path = stellar_model_path();
    if !model_path.exists() {
        eprintln!(
            "intent_stellar_golden2 skipped: model not found at {}",
            model_path.display()
        );
        return;
    }
    ...
    let cases: &[Case] = &[
        ...
        Case {
            text: "Create account GC6FLLQELHZ3GXDXFIIMJ477E2FVEI2PFSM4AD4IXELERA4ZUUPVLBLQ with starting balance 2",
            primary_label: "CreateAccount",
            accepted_labels: &["CreateAccount"],
            accepted_action_kinds: &["stellar.account.create"],
            min_score: 0.30,
        },
        Case {
            text: "create acccount GBSBBQGSMZEZJLPCQZFIDSEUSUEZVKP3KHS3JKV27BSWWTUL35VEL72P with startng balance 1.25 XLM",
            primary_label: "CreateAccount",
            accepted_labels: &["CreateAccount", "TransferXLM", "TransferAsset"],
        ...
        Case {
            ...
            accepted_labels: &["ChangeTrust"],
            accepted_action_kinds: &["stellar.change_trust"],
            min_score: 0.30,
        },
        Case {
        ...
        Case {
            text: "Send 5 XLM to GBSBBQGSMZEZJLPCQZFIDSEUSUEZVKP3KHS3JKV27BSWWTUL35VEL72P",
            primary_label: "TransferXLM",
            accepted_labels: &["TransferXLM"],
            accepted_action_kinds: &["stellar.payment"],
            min_score: 0.30,
        },
        Case {
            text: "sendd 5 xIm to GCBYKY5GGH4GYUE5AXAUGUS4VUQAQAEO5YMSEJSD2OLC2WBAXEXAJGZQ !!!",
            primary_label: "TransferXLM",
        ...
        Case {
            text: "run payment 3.33 XLM to GC6FLLQELHZ3GXDXFIIMJ477E2FVEI2PFSM4AD4IXELERA4ZUUPVLBLQ and then check balance GC6FLLQELHZ3GXDXFIIMJ477E2FVEI2PFSM4AD4IXELERA4ZUUPVLBLQ",
            primary_label: "TransferXLM",
            accepted_labels: &["TransferXLM", "BalanceQuery", "TransferAsset"],
            accepted_action_kinds: &["stellar.payment", "stellar.account.balance", "unknown"],
            min_score: 0.15,
        },
        Case {
            text: "Send 12.5 TESTUSD:GCAL4PIFKWOIFO6YT4T7TSSES7SJCWV7HN7XAUTNFFSGQK74RFUSAJBX to GCBYKY5GGH4GYUE5AXAUGUS4VUQAQAEO5YMSEJSD2OLC2WBAXEXAJGZQ",
        ...
        Case {
            text: "trnsfer 4 USDC:GBBD47IF6LWK7P7MDEVSCWR7DPUWV3NY3DTQEVFL4NAT4AQH3ZLLFLA5 to GC5IPWDT6CXXHPQVOETX2AHKABSSSYOSZFWGOLCRJM56AFMDSTMLV3KL",
            primary_label: "TransferAsset",
            accepted_labels: &["TransferAsset"],
            accepted_action_kinds: &["stellar.payment"],
            min_score: 0.18,
        ...
        Case {
            text: "run send 7 TESTUSD:GCAL4PIFKWOIFO6YT4T7TSSES7SJCWV7HN7XAUTNFFSGQK74RFUSAJBX to GBSBBQGSMZEZJLPCQZFIDSEUSUEZVKP3KHS3JKV27BSWWTUL35VEL72P and then check tx status aaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa",
            primary_label: "TransferAsset",
            accepted_labels: &["TransferAsset", "TxStatus"],
            accepted_action_kinds: &["stellar.payment", "stellar.tx.status"],
            min_score: 0.15,
        },
        Case {
        ...
        Case {
            text: "trigger friendbot refill to GCBYKY5GGH4GYUE5AXAUGUS4VUQAQAEO5YMSEJSD2OLC2WBAXEXAJGZQ",
            primary_label: "FundTestnet",
            accepted_labels: &["FundTestnet", "TransferAsset"],
            accepted_action_kinds: &["stellar.account.fund_testnet", "stellar.payment", "unknown"],
            min_score: 0.18,
        },
        Case {
        ...
        Case {
            text: "check tx sttus deadbeefdeadbeefdeadbeefdeadbeefdeadbeefdeadbeefdeadbeefdeadbeef",
            primary_label: "TxStatus",
            accepted_labels: &["TxStatus", "TransferAsset"],
            accepted_action_kinds: &["stellar.tx.status", "stellar.payment", "unknown"],
            min_score: 0.15,
        },
        Case {
        ...
        Case {
            text: "trigger random quote generator",
            primary_label: "Unknown",
            accepted_labels: &["Unknown"],
            accepted_action_kinds: &["unknown"],
            min_score: 0.15,
